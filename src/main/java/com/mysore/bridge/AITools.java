...
public class AITools {
    ...
    public  Object invokeClass(String promptText,String className, String funName, String description) {
        try (VertexAI vertexAI = new VertexAI(projectId, location)) {
            JavaClassBridge generator = new JavaClassBridge();
           ...
           String jsonString = generator.getPropertyValuesJsonString(response);
            ...
            return generator.invoke(response,jsonString);
